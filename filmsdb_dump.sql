...
INSERT INTO `films` VALUES (1,'Inception','Un homme tente de faire voler des idées dans le subconscient.',1,1,12.99),(2,'Django Unchained','Un esclave affranchi devient un chasseur de primes.',3,1,11.99),(3,'Terminator 2','Le T-800 doit protéger un jeune garçon.',4,1,10.99),(4,'The Dark Knight','Batman lutte contre le Joker pour sauver Gotham.',1,1,13.99),(5,'Saving Private Ryan','En mission de sauvetage pendant la Seconde Guerre mondiale.',2,1,9.99),(6,'Mad Max: Fury Road','La guerre post-apocalyptique dans le désert.',6,1,14.99),(7,'Gladiator','Un général romain cherche à venger la mort de sa famille.',6,1,13.99),(8,'John Wick','Un ancien tueur à gages revient pour venger son chien.',7,1,12.99),(9,'The Avengers','Les super-héros unissent leurs forces pour sauver la Terre.',8,1,15.99),(10,'Fast & Furious 7','Les véhicules et l’action pour protéger les siens.',9,1,11.99),(11,'Shutter Island','Une enquête sur une disparition dans un hôpital psychiatrique.',5,2,12.99),(12,'The Departed','L’histoire de deux hommes infiltrés dans le crime et la police.',5,2,11.99),(13,'The Pursuit of Happyness','Un père et son fils luttent pour survivre à la pauvreté.',2,2,10.99),(14,'A Beautiful Mind','L’histoire d’un mathématicien brillant mais atteint de schizophrénie.',2,2,13.99),(15,'Forrest Gump','Un homme simple mais avec une vie extraordinaire.',2,2,9.99),(16,'The Shawshank Redemption','Un homme condamné à tort trouve l’espoir derrière les barreaux.',2,2,14.99),(17,'The Green Mile','Un gardien de prison et un condamné possédant des pouvoirs spéciaux.',10,2,12.99),(18,'The Godfather','Une famille mafieuse et la succession du pouvoir.',10,2,15.99),(19,'The Social Network','L’histoire de la création de Facebook et des conflits qui en ont découlé.',9,2,13.99),(20,'Titanic','L’histoire d’un amour tragique sur le Titanic.',4,2,11.99);
...
-- Dump completed on 2025-04-17  9:08:40
